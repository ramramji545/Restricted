...
LOG_GROUP = getenv("LOG_GROUP", "-1003161993313")
CHANNEL_ID = int(getenv("CHANNEL_ID", "-1003161993313"))
FREEMIUM_LIMIT = int(getenv("FREEMIUM_LIMIT", "587"))
PREMIUM_LIMIT = int(getenv("PREMIUM_LIMIT", "878"))
